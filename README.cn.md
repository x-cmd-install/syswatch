...
合计: **18,178** 行代码（覆盖前 5 种语言、共 **50** 个文件）。
...
- **发布数**: 25 · **已合并 PR**: 11 · **开放 PR**: 0 · **已关闭 issue**: 13 · **开放 issue**: 0 · **提交数**: 82
...
在 [repology.org](https://repology.org/project/syswatch) 上共有 **5** 个发行版报告此项目。**3** 个 ✅ 已是最新上游版本，**2** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260910.yml` · 2026-09-10T20:17:49Z._
